...
{
    public partial class PrintForm111 : BaseForm
    {
        ...
        /// 技能領域(true: 部必)
        /// </summary>
        bool boolSkillDomain = true;

        /// <summary>
        /// 國英數(true: 部必)
        /// </summary>
        bool boolChineseEngMath = true;
        ...
        private void BgExportData_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            // 讀取樣板
            Workbook wb = new Workbook(new MemoryStream(Properties.Resources.Template111));
            ...
            foreach (StudentInfo si in StudentList)
            {
                ...
                if (StudentScoreDict.ContainsKey(si.StudentID))
                {
                    ...
                    if (StudentScoreDict[si.StudentID].ContainsKey("技能領域_學群排名"))
                    {
                        // 技能領域科目平均成績 10
                        if (StudentScoreDict[si.StudentID]["技能領域_學群排名"].Score.HasValue)
                            wstD.Cells[wstDrIdx, 10].PutValue(StudentScoreDict[si.StudentID]["技能領域_學群排名"].Score.Value);

                        // 技能領域科目群名次 11 
                        if (StudentScoreDict[si.StudentID]["技能領域_學群排名"].Rank.HasValue)
                            wstD.Cells[wstDrIdx, 11].PutValue(StudentScoreDict[si.StudentID]["技能領域_學群排名"].Rank.Value);

                        // 技能領域科目群百分比 12 
                        if (StudentScoreDict[si.StudentID]["技能領域_學群排名"].Percentile.HasValue)
                            wstD.Cells[wstDrIdx, 12].PutValue(StudentScoreDict[si.StudentID]["技能領域_學群排名"].Percentile.Value);
                    }
                    ...
                    if (StudentScoreDict[si.StudentID].ContainsKey("英文_學群排名"))
                    {
                        ...
                        if (StudentScoreDict[si.StudentID]["英文_學群排名"].Score.HasValue)
                            wstD.Cells[wstDrIdx, 13].PutValue(StudentScoreDict[si.StudentID]["英文_學群排名"].Score.Value);

                        // 英文群名次 14 
                        if (StudentScoreDict[si.StudentID]["英文_學群排名"].Rank.HasValue)
                            wstD.Cells[wstDrIdx, 14].PutValue(StudentScoreDict[si.StudentID]["英文_學群排名"].Rank.Value);

                        // 英文群百分比 15 
                        if (StudentScoreDict[si.StudentID]["英文_學群排名"].Percentile.HasValue)
                            wstD.Cells[wstDrIdx, 15].PutValue(StudentScoreDict[si.StudentID]["英文_學群排名"].Percentile.Value);
                    }
                    ...
                    if (StudentScoreDict[si.StudentID].ContainsKey("國文_學群排名"))
                    {
                        ...
                        if (StudentScoreDict[si.StudentID]["國文_學群排名"].Score.HasValue)
                            wstD.Cells[wstDrIdx, 16].PutValue(StudentScoreDict[si.StudentID]["國文_學群排名"].Score.Value);

                        // 國文群名次 17 
                        if (StudentScoreDict[si.StudentID]["國文_學群排名"].Rank.HasValue)
                            wstD.Cells[wstDrIdx, 17].PutValue(StudentScoreDict[si.StudentID]["國文_學群排名"].Rank.Value);

                        // 國文群百分比 18 
                        if (StudentScoreDict[si.StudentID]["國文_學群排名"].Percentile.HasValue)
                            wstD.Cells[wstDrIdx, 18].PutValue(StudentScoreDict[si.StudentID]["國文_學群排名"].Percentile.Value);
                    }
                    ...
                    if (StudentScoreDict[si.StudentID].ContainsKey("數學_學群排名"))
                    {
                        ...
                        if (StudentScoreDict[si.StudentID]["數學_學群排名"].Score.HasValue)
                            wstD.Cells[wstDrIdx, 19].PutValue(StudentScoreDict[si.StudentID]["數學_學群排名"].Score.Value);

                        // 數學群名次 20 
                        if (StudentScoreDict[si.StudentID]["數學_學群排名"].Rank.HasValue)
                            wstD.Cells[wstDrIdx, 20].PutValue(StudentScoreDict[si.StudentID]["數學_學群排名"].Rank.Value);

                        // 數學群百分比 21 
                        if (StudentScoreDict[si.StudentID]["數學_學群排名"].Percentile.HasValue)
                            wstD.Cells[wstDrIdx, 21].PutValue(StudentScoreDict[si.StudentID]["數學_學群排名"].Percentile.Value);
                    }
                }
            ...
            foreach (StudentInfo si in StudentList)
            {
                ...
                if (StudentScoreDict.ContainsKey(si.StudentID))
                {
                    ...
                    if (StudentScoreDict[si.StudentID].ContainsKey("技能領域_學群排名"))
                    {
                        // 技能領域科目_學群排名平均成績群名次 10
                        if (StudentScoreDict[si.StudentID]["技能領域_學群排名"].Rank.HasValue)
                            wstR.Cells[wstRrIdx, 10].PutValue(StudentScoreDict[si.StudentID]["技能領域_學群排名"].Rank.Value);
                    }
                    ...
                    if (StudentScoreDict[si.StudentID].ContainsKey("英文_學群排名"))
                    {
                        // 英文平均成績群名次 11
                        if (StudentScoreDict[si.StudentID]["英文_學群排名"].Rank.HasValue)
                            wstR.Cells[wstRrIdx, 11].PutValue(StudentScoreDict[si.StudentID]["英文_學群排名"].Rank.Value);
                    }
                    ...
                    if (StudentScoreDict[si.StudentID].ContainsKey("國文_學群排名"))
                    {
                        // 國文平均成績群名次 12
                        if (StudentScoreDict[si.StudentID]["國文_學群排名"].Rank.HasValue)
                            wstR.Cells[wstRrIdx, 12].PutValue(StudentScoreDict[si.StudentID]["國文_學群排名"].Rank.Value);
                    }
                    if (StudentScoreDict[si.StudentID].ContainsKey("數學_學群排名"))
                    {
                        // 數學平均成績群名次 13
                        if (StudentScoreDict[si.StudentID]["數學_學群排名"].Rank.HasValue)
                            wstR.Cells[wstRrIdx, 13].PutValue(StudentScoreDict[si.StudentID]["數學_學群排名"].Rank.Value);
                    }
                }
        ...
        private void PrintForm_Load(object sender, EventArgs e)
        {
            ...
            string item1 = "學業、專業及實習(部定必修)、技能領域(部定必修)、國英數(部定必修)";
            string item2 = "學業、專業及實習、技能領域、國英數";
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            boolPro=ckProReq.Checked;
            boolSkillDomain = ckSkillDomainReq.Checked;
            boolChineseEngMath = ckCEMReq.Checked;
